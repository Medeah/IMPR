...
#include <stdio.h>
#define ___ point_in_circle(x, y,
...
int main(void)
{
    ...
    for (y = 0; y < 500; y++)
        for (x = 0; x < 500; x++) {
             ...
             ( ___ 319, 196, 65) && y < 220) ?
                ((___ 362, 155, 26)) ? (b =g = r = 0) : (b =g = r = 0xFF))
            :
             (___ 319, 196, 76) && y < 231) ?
                (b =g = r = 0)
            :
             (___ 109, 196, 65) && y < 220) ?
                (___ 137, 155, 26) ? (b =g = r = 0) :(b =g = r = 0xFF))
            :
             (___ 109, 196, 76) && y < 231) ?
                (b =g = r = 0)
            :
             (___ 220, 297, 128) && y > 289) ?
                (___ 276, 448, 82) ? ( (r = 251)+(g = 192)+(b = 223) ) : ( (r = 135)+(g = 25)+(b = 69) ))
            :
             (___ 220, 297, 139) && y > 289 - 11) ?
                (b =g = r = 0)
            : 
             (___ 250, 250, 229)) ?
                ((r = 254)+(g = 222)+(b = 88))
