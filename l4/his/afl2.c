    ...
    for (y = 0; y < 500; y++)
        for (x = 0; x < 500; x++) {
            ...
            if ( point_in_circle(x, y, 319, 196, 65) && y < 220) 
                (point_in_circle(x, y, 362, 155, 26)) ? (b =g = r = 0) : (b =g = r = 0xFF);
            else if (point_in_circle(x, y, 319, 196, 76) && y < 231) 
                b =g = r = 0;
            else if (point_in_circle(x, y, 109, 196, 65) && y < 220) 
                point_in_circle(x, y, 137, 155, 26) ? (b =g = r = 0) :(b =g = r = 0xFF);
            else if (point_in_circle(x, y, 109, 196, 76) && y < 231)
                b =g = r = 0;
            else if (point_in_circle(x, y, 220, 297, 128) && y > 289) 
                point_in_circle(x, y, 276, 448, 82) ? ( (r = 251)+(g = 192)+(b = 223) ) : ( (r = 135)+(g = 25)+(b = 69) );
            else if (point_in_circle(x, y, 220, 297, 139) && y > 289 - 11) 
                b =g = r = 0;
